...
function ordenarFechaMenorMayor($a,$b)
{

    if (validarFecha($a["fecha"]) == validarFecha($b["fecha"])) 
    {
        return 0;//no se mueve
    }
    if(validarFecha($a["fecha"]) < validarFecha($b["fecha"]))
    {
        return -1;//a se coloca atras de b
    }
    else
    {
        return 1;//a se coloca despues de b
    }
     
}

function ordenarFechaMayorMenor($a,$b)
{
